...
public class Player {
    ...
    public void setInJailStatus(boolean status) {
        inJail = status;
    }
    ...
    public void setEscapeAttempts(int amount) {
        escapeAttempt = amount;
    }
    ...
    public int getTurnsInRow() {
        return turnsInRow;
    }

    public void setTurnsInRow(int amount) {
        turnsInRow = amount;
    }

    public void incrementTurnsInRow() {
        turnsInRow++;
    }
